...
export function Dashboard({ assets }: DashboardProps) {
  ...
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-2xl text-black mb-2">Dashboard</h2>
        <p className="text-gray-800">Overview of your asset management system</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <h3 className="text-lg text-black mb-4">Assets by Category</h3>
        ...
        {/* Status Distribution */}
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <h3 className="text-lg text-black mb-4">Status Distribution</h3>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
              ...
              <span className="text-black">{activeAssets}</span>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
              ...
              <span className="text-black">{maintenanceAssets}</span>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg">
              ...
              <span className="text-black">{lostAssets}</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="bg-white rounded-lg p-4 border border-red-200">
                <h4 className="text-sm text-black mb-3">Lost Items:</h4>
